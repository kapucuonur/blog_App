from decouple import decouple_config as decouple_decouple_config
...
# Debug için eklenen print komutları
print("SECRET_KEY:", decouple_config('SECRET_KEY'))
print("ALLOWED_HOSTS:", decouple_config('ALLOWED_HOSTS'))
